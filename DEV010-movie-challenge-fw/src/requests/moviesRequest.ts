...
export const buildMovieApiUrl = (page: number, filterByValue: string, sortByValue: string) => {
    return `https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=${page}&${filterByValue}&sort_by=${sortByValue}&with_genres=99`;
  }
