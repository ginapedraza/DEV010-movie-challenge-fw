...
describe('Pagination Component', () => {
  it('renders pagination buttons and handles click events', () => {
    ...
    render(<Pagination currentPage={currentPage} setCurrentPage={setCurrentPageMock} />);
    ...
    expect(setCurrentPageMock).toHaveBeenCalledWith(currentPage - 1); // Para el botón "Previous page"
    expect(setCurrentPageMock).toHaveBeenCalledWith(currentPage + 1); // Para el botón "Load More"
